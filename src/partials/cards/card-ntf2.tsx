        ...
        <Card className="overflow-hidden rounded-xl">
            ...
            <CardContent className="pt-0">
                ...
                <div className="flex items-center justify-center gap-1.5 mb-px -mt-7.5">
                    <Link to="#" className="hover:text-primary-active text-base leading-5 font-medium text-mono">
                        {name}
                    </Link>
                    <svg
                ...
                <div className="flex flex-wrap justify-center items-center gap-3.5 mb-7">
                    <Link to="#" className="text-xs text-secondary-foreground hover:text-primary-active">
                        {email}
                    </Link>
